...
comps::GhostAIComponent::GhostAIComponent(std::shared_ptr<comps::BoundingBoxComponent> pPlayerBoundingBoxComp, std::shared_ptr<comps::HealthComponent> pPlayerHealthComp
